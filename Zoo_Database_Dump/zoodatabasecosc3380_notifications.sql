...
CREATE TABLE `notifications` (
  ...
  `notificationcontent` varchar(160) NOT NULL,
  `to_notify` tinyint NOT NULL DEFAULT '1',
  `deleted` tinyint NOT NULL DEFAULT '0',
  PRIMARY KEY (`notificationid`),
  UNIQUE KEY `notificationid` (`notificationid`),
  KEY `notifications_employeeid` (`employeeid`),
  CONSTRAINT `notifications_employeeid` FOREIGN KEY (`employeeid`) REFERENCES `employees` (`employeeid`)
